...
public class DocumentIndexer {
    ...
    public static void main(String[] args) {
        if ((args.length != 3) || !(args[2].toLowerCase().equals("vsm") || args[2].toLowerCase().equals("bm25"))) {
            System.out.println("Error! Parameters: corpusFilename stopWordsList rankingMethod[\"vsm\" OR \"bm25\"]");
            return;
        }
        try {
            ...
            if(args[2].toLowerCase().equals("vsm")) //Vector Space Model
                ...
                indexer.corpusReader(args[0], args[2].toLowerCase(), index_bm25_filename, index_docIDs_bm25_filename);  //Entry point
